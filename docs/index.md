...
- **Local caching:** Analysis results are cached locally to minimize API calls. GitHub token required for analysis.
...
- **Minimal Setup** - Requires a GitHub token for analysis
